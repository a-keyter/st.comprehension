...
st.title("AI Powered Teaching!")
st.header("Turn Videos into Learning Resources!")
st.write("This is a simple Generative AI application that turns YouTube Videos into learning resources in minutes!")
...
st.write("To find out more about my work connect with me on LinkedIn - https://www.linkedin.com/in/alex-keyter/")
st.divider()
...
if generate:
    ...
    loader = YoutubeLoader.from_youtube_url(user_link, add_video_info=False, language=lang_codes[target_lang])
    ...
    # Get Key Vocab
        ...
        worksheet.add_paragraph(user_link)
        link = worksheet.paragraphs[-1]
